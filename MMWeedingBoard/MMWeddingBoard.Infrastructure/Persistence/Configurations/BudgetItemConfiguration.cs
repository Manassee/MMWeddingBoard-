...
public sealed class BudgetItemConfiguration : IEntityTypeConfiguration<BudgetItem>
{
    public void Configure(EntityTypeBuilder<BudgetItem> b)
    {
        ...
        b.HasKey(x => x.Id);
        b.Property(x => x.Id).HasColumnName("budget_item_id");

        b.Property(x => x.BudgetId).HasColumnName("budget_id").IsRequired();
        ...
        b.Property(x => x.PaymentStatus).HasColumnName("payment_status").HasConversion<int>().IsRequired();
